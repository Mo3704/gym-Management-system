                ...
                <table class="table  table-hover table-responsive  table-primary">
                    ...
                    <tbody>
                        ...
                        if ($_POST['submit']) {
                            ...
                            $sql = mysqli_query($conn, "SELECT id,name,EXP_DT,amount,phone FROM expired_clients WHERE id LIKE '%$search_file%' OR name LIKE '%$search_file%' OR EXP_DT LIKE '%$search_file%' OR amount LIKE '%$search_file%' OR phone LIKE '%$search_file%'");
